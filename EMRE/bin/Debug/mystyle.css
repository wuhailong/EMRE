...
<STYLE>TABLE.sortEnabled TR.firstRow TH {
	BACKGROUND-IMAGE: url(file://E:/Github/EMRE/EMRE/bin/Debug/Editor/themes/default/images/sortable.png); PADDING-RIGHT: 20px; BACKGROUND-REPEAT: no-repeat; BACKGROUND-POSITION: right center
}
...
TD {
	BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; PADDING-BOTTOM: 5px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; BORDER-TOP: #ddd 1px solid; BORDER-RIGHT: #ddd 1px solid; PADDING-TOP: 5px
}
TH {
	BORDER-BOTTOM: #ddd 1px solid; BORDER-LEFT: #ddd 1px solid; PADDING-BOTTOM: 5px; PADDING-LEFT: 10px; PADDING-RIGHT: 10px; BORDER-TOP: #ddd 1px solid; BORDER-RIGHT: #ddd 1px solid; PADDING-TOP: 5px
}
...
<STYLE>.loadingclass {
	BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; WIDTH: 22px; DISPLAY: inline-block; BACKGROUND: url(file://E:/Github/EMRE/EMRE/bin/Debug/Editor/themes/default/images/loading.gif) no-repeat center center; HEIGHT: 22px; BORDER-TOP: #cccccc 1px solid; CURSOR: default; MARGIN-RIGHT: 1px; BORDER-RIGHT: #cccccc 1px solid
}
.loaderrorclass {
	BORDER-BOTTOM: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; WIDTH: 22px; DISPLAY: inline-block; BACKGROUND: url(file://E:/Github/EMRE/EMRE/bin/Debug/Editor/themes/default/images/loaderror.png) no-repeat center center; HEIGHT: 22px; BORDER-TOP: #cccccc 1px solid; CURSOR: default; MARGIN-RIGHT: 1px; BORDER-RIGHT: #cccccc 1px solid
}
</STYLE>
